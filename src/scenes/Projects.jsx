...
const Project = ({ title }) => {
  const overlayStyles = `absolute h-full w-full opacity-0 hover:opacity-90 transition duration-500 bg-gradient-to-r from-red to-blue z-30 flex flex-col justify-center items-center text-center p-16 text-deep-blue`;
